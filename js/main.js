...
([
	...
	(function(module, exports, __webpack_require__) {
		...
		var Snowflake = function(_Particle) {
			...
			function Snowflake() {
				...
				var _this = _possibleConstructorReturn(this, (Snowflake.__proto__ || Object.getPrototypeOf(Snowflake)).call(this, {
					x: x,
					y: y,
					minSize: minSize,
					maxSize: maxSize,
	...
	(function(module, exports, __webpack_require__) {
		...
		var Heart = function(_Snowflake) {
			...
			function Heart() {
				...
				var _this = _possibleConstructorReturn(this, (Heart.__proto__ || Object.getPrototypeOf(Heart)).call(this, {
					minSize: minSize,
					maxSize: maxSize,
					x: x,
					y: y,
	...
	(function(module, exports, __webpack_require__) {
		...
		var FireworkParticle = function(_Particle) {
			...
			function FireworkParticle(_ref) {
				...
				var _this = _possibleConstructorReturn(this, (FireworkParticle.__proto__ || Object.getPrototypeOf(FireworkParticle)).call(this, {
					x: x,
					y: y,
					size: size
				}));
				...
				_createClass(Canvas, [{
					...
					value: function getDotsPostion(wordsArr, showFireworks) {
						...
						words.forEach(function(item, index) {
							...
							var prtOption = {};
							showFireworks && _this5.fireworks.push(new _fireworks2.default({
								wait: 30,
								radius: 2,
								x: x,
								yEnd: y,
			...
			_createClass(Firework, [{
				...
				value: function createParticles() {
					for(var i = 0; i < this.count; ++i) {
						this.particles.push(new _fireworkParticle2.default({
							x: this.xEnd,
							y: this.yEnd,
							radius: this.radius
						}));
	...
	(function(module, exports, __webpack_require__) {
		...
		var FireworkWords = function(_FireworkParticle) {
			...
			function FireworkWords(_ref) {
				...
				var _this = _possibleConstructorReturn(this, (FireworkWords.__proto__ || Object.getPrototypeOf(FireworkWords)).call(this, {
					x: x,
					y: y,
					size: size,
					circle: circle
	...
	(function(module, exports, __webpack_require__) {
		...
		var TitleParticle = function(_Heart) {
			...
			function TitleParticle(_ref) {
				...
				var _this = _possibleConstructorReturn(this, (TitleParticle.__proto__ || Object.getPrototypeOf(TitleParticle)).call(this, {
					x: xStart,
					y: yStart,
					minSize: minSize,
					maxSize: maxSize,
	...
	(function(module, exports, __webpack_require__) {
		...
		module.exports = __webpack_require__.p + "audio/1.mp3";
